...
### Created by Peter Forret ( pforret ) on 2026-08-10
...
readonly script_created="2026-08-10"
readonly run_as_root=-1 # run_as_root: 0 = don't check anything / 1 = script MUST run as root / -1 = script MAY NOT run as root
readonly script_description="generate beautiful PDF from Markdown sources"
